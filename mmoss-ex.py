...
mMOSS "trivial" Client sub-class implementation. This is intended to be a 
sample implementation of the mMOSS game client.
...
from mmoss.controller import Controller, A,S,D,Q,W,SPACE,TAB
