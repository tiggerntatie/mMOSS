...
Tutorial 5: Weapon/Fuel/Shield strength display
Tutorial 5a: Text on weapon/fuel/shield display - full screenQ 
...
from mmoss.utility import MMOSSShip, MMOSSBullet, MMOSSAsteroid, Controller
from mmoss.utility import MMOSSDisplayableObject, MMOSSFactory
from mmoss.utility import A,S,D,Q,W,SPACE,TAB,LEFT,RIGHT,UP,DOWN,F
    ...
    def joinResponse(self, myid, thetime, gamewidth, gameheight):
        ...
        if self.screen is None:
            self.screen = pygame.display.set_mode(self.screensize,
                pygame.FULLSCREEN if self.arguments.full_screen else 0)
...
app.parser.add_argument('--full-screen','-f', action='store_true',  
                            help='run mMOSS in fullscreen mode')
